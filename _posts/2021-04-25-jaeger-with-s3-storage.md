...
Since Jaeger supports "plugins" using Hashicorp's [go-plugin](https://github.com/hashicorp/go-plugin), i and my team decided to build our own ann i volunteered to develop the plugin for S3 storage. The Jaeger-S3 Plugin is available [here](https://github.com/muhammadn/jaeger-s3).
